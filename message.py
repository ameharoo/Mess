...
class MessageField:
    ...
    message_name: str
    docs: str = ""
    _manager: 'MessageManager' = None

    def get_message(self) -> 'Message':
        return self._manager.get(self.message_name)
...
class Message:
    ...
    def __init__(self, name, fields, generic_args=None, docs=""):
    ...
    def __str__(self):
        return self.get_serialized_message_name()
...
#     doc: str
#
#     def __init__(self, message_manager: 'MessageManager', _type: str, name: str, doc: str):
...
#         obj = None
#         if self.type == "VarArray":
#             nested_type = self.message_manager.get(self.generic_args[0])
#             obj = self.message_manager.get(self.type)(self.name, nested_type)
#         elif self.generic_args:
#             raise Exception(f"Unknown generic message {self.type} with args {self.generic_args}")
#         else:
#             obj = self.message_manager.get(self.type)(self.name)
#
#         obj.docs = self.doc
#
#         return obj
